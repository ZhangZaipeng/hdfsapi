...
public class WordCount2 {
	public static class TokenizerMapper extends
		...
		public void map(Object key, Text value, Context context)
			...
			String line = value.toString();// 全部转为小写字母
	...
	public static void run () throws Exception {
		Configuration conf = new Configuration();
		 Path tempDir = new Path("hdfs://master:9000/temp"); //定义一个临时目录
		...
		try{
			...
			FileInputFormat.addInputPath(job, new Path("hdfs://master:9000/input/namelist.txt"));
			...
			if(job.waitForCompletion(true))
			{
	            ...
	            FileOutputFormat.setOutputPath(sortJob, new Path("hdfs://master:9000/output"));
